...
def U_Ux_CCE_Entropy(U_con_data,U_dec_data,Ux_con_data,Ux_dec_data):
    ...
    U_Ux_con_divlist, U_Ux_dec_divlist = merge_divlist(U_con_data,Ux_con_data,U_dec_data,Ux_dec_data,U_con_divlist,U_dec_divlist,Ux_con_divlist,Ux_dec_divlist)
    print(U_Ux_con_divlist, U_Ux_dec_divlist)
    print((U_len * (U_len - 1) * CCE_Entropy(U_con_divlist,U_dec_divlist) + len(set(U_Ux_con_divlist) - set(U_Ux_dec_divlist)) * (3 * len(U_Ux_con_divlist) + 3 * len(set(U_Ux_con_divlist) & set(U_Ux_dec_divlist)) - 5))/math.pow(U_len + 1,2))
