...
if __name__ == "__main__":
    ...
    U_sp_matrix = get_matrix(con_data)
    con_list = [i for i in range(len(con_data[0]))]
    dec_divlist = div(dec_data)
    ne_entropy = NE_entropy(U_sp_matrix,con_list, dec_divlist)
    core_list = core(U_sp_matrix, con_list, dec_divlist,ne_entropy)
    print(core_list,"core_list")
    red(U_sp_matrix,con_list,dec_divlist,core_list,ne_entropy)
