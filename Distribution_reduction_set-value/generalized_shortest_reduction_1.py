...
if __name__ == '__main__':
    ...
    MinReduct = shortest_Red(DM,con_data)
#     # #单特定类
    start_1 = time.perf_counter()
    DM_1 = Matrix_construct_partical(con_data,gd_list,con_divlist,dec_divlist[class_num],dec_data)
    MinReduct_1 = shortest_Red(DM_1,con_data)

    # 单2
    start_2 = time.perf_counter()
    DM_2 = Matrix_construct_partical(con_data,gd_list,con_divlist,dec_divlist[class_num_1],dec_data)
    MinReduct_2 = shortest_Red(DM_1,con_data)

    # #多特定类
    start_3 = time.perf_counter()
    DM_3= Matrix_construct_partical(con_data,gd_list,con_divlist,dec_divlist[class_num] + dec_divlist[class_num_1],dec_data)
    MinReduct_3 = shortest_Red(DM_3,con_data)
    ...
    print("单特定类2:")
    print(set(MinReduct_2), len(MinReduct_2))
    print("多特定类:")
