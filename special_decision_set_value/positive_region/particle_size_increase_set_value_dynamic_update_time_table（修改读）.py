...
if __name__ == '__main__':
    ...
    # ######    单类K=8
    print("K=8:")
    start_updt_2 = time.perf_counter()
    pos_list_2 = pos_specialDec(dec_divlist_2[class_num_2], con_divlist)
    # print("pos_list_2", pos_list_2, len(pos_list_2))
    start_updt_c = time.perf_counter()
    updt_DM_2 = Dynamic_matrix_construct(DM_1, pos_list_1, pos_list_2, dec_divlist_1[class_num_1], dec_divlist_2[class_num_2],con_data,dec_data_2)
    end_updt_c = time.perf_counter()
    reduct_list_2 = Red(updt_DM_2)
    end_updt_2 = time.perf_counter()
    ...
    print("CPRM d2构造:", end_c - start_c, "CPRM d2约简:", end_2 - start_2)
    print("DUM d2构造:", end_updt_c - start_updt_c, "DUM d2约简:", end_updt_2 - start_updt_2)

    for s in range(len(DM_2)):
        if (DM_2[s] != updt_DM_2[s]):
            print("2竟然有不相等的！"*100)
    ...
    print()
    print("K=16:")
    start_updt_3 = time.perf_counter()
    pos_list_3 = pos_specialDec(dec_divlist_3[class_num_3], con_divlist)
    # print("pos_list_2", pos_list_2, len(pos_list_2))
    start_updt_c = time.perf_counter()
    updt_DM_3 = Dynamic_matrix_construct(DM_2, pos_list_2, pos_list_3, dec_divlist_2[class_num_2],
                                         dec_divlist_3[class_num_3], con_data, dec_data_3)
    end_updt_c = time.perf_counter()
    reduct_list_3 = Red(updt_DM_3)
    end_updt_3 = time.perf_counter()
    ...
    print("CPRM d3构造:", end_c - start_c, "CPRM d3约简:", end_3 - start_3)
    print("DUM d3构造:", end_updt_c - start_updt_c, "DUM d3约简:", end_updt_3 - start_updt_3)

    for s in range(len(DM_3)):
        if (DM_3[s] != updt_DM_3[s]):
            print("3竟然有不相等的！" * 100)
