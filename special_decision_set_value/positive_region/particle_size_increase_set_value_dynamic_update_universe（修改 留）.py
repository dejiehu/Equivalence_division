...
def Dynamic_matrix_construct(pre_DM,pre_pos_list,new_pos_list,pre_dec_list,new_dec_list,con_data,dec_data):
    if (pre_pos_list == new_pos_list and pre_dec_list == new_dec_list):
        return pre_DM
    new_DM = pre_DM
    # new_DM = [['None'] * len(con_data) for _ in range(len(con_data))]
...
def find_specialClass(dec_data_1,dec_data_2,dec_data_3,i):
    temp_dec_data_1 = dec_data_1[0:int(len(dec_data_1) * (i + 1) / 10)]
    dec_divlist_1 = div_dec(temp_dec_data_1)
    temp_dec_data_2 = dec_data_2[0:int(len(dec_data_2) * (i + 1) / 10)]
    dec_divlist_2 = div_dec(temp_dec_data_2)
    temp_dec_data_3 = dec_data_3[0:int(len(dec_data_3) * (i + 1) / 10)]
    dec_divlist_3 = div_dec(temp_dec_data_3)
    #####找最小
    ...
    return dec_divlist_1[class_num_1],dec_divlist_2[class_num_2],dec_divlist_3[class_num_3]
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        dec_list_1,dec_list_2,dec_list_3 = find_specialClass(dec_data_1, dec_data_2, dec_data_3, i)
        '''
        start = time.perf_counter()
        ...
        pos_list_1 = pos_specialDec(dec_list_1, con_divlist)
        # pos_list_1 = [2,3]
        ...
        # ######    单类K=8
        # print("K=8:")
        pos_list_2 = pos_specialDec(dec_list_2, con_divlist)
        # print("pos_list_2", pos_list_2, len(pos_list_2))
        start_2 = time.perf_counter()
        new_DM = Dynamic_matrix_construct(DM_1, pos_list_1, pos_list_2,dec_list_1, dec_list_2,temp_con_data,dec_data_2)
